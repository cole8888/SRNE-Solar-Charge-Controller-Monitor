...
(function () {
  ...
  function darkMode() {
    document
      .querySelectorAll(
        ".bg-light, .custom-card-light, .custom-modal-light, .custom-modal-header-light, .custom-btn-close-light"
      )
      .forEach((element) => {
  ...
  function lightMode() {
    document
      .querySelectorAll(
        ".bg-dark, .custom-card-dark, .custom-modal-dark, .custom-modal-header-dark, .custom-btn-close-dark"
      )
      .forEach((element) => {
